      ...
      >
        <div className="hero-content text-center">
          <div className="max-w-2xl space-y-6">
            ...
            >
              Unlock your potential with expert-led courses. Learn from
              industry professionals and level-up your career.
            </motion.p>
            <motion.div
        ...
        <div className="container mx-auto px-4 space-y-10">
          <header className="text-center space-y-2" data-aos="fade-up">
            ...
            <p className="opacity-70">
              Discover our most loved courses taught by expert instructors
            </p>
          </header>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Array.from({ length: 6 }).map((_, idx) => (
                <div
                  key={idx}
                  className="card bg-base-200 shadow-sm animate-pulse"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "Explore a wide range of topics from beginner to advanced",
              },
              {
                icon: "⏱️",
        ...
        <div className="container mx-auto px-4 space-y-10">
          ...
          {topInstructors.length ? (
                ...
                >
                  ...
                  <div className="card-body items-center text-center space-y-2">
                    ...
                    <p className="text-sm opacity-70">
                      {Number(instructor.students || 0).toLocaleString()}+{" "}
                      Students
                    </p>
                  </div>
                </motion.div>
            ...
            <div className="text-center opacity-70">
              Instructors will appear once courses load.
            </div>
          )}
        </div>
      </section>
